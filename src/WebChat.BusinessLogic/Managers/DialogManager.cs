...
namespace WebChat.BusinessLogic.Managers
{
    public class DialogManager
    {
        ...
        public ChatDialog CreateDialog(ChatClient client, ChatAgent agent, string AppKey)
        {
            ChatDialog dilog = new ChatDialog()
            {
        ...
        public IEnumerable<JObject> GetAllMessagesInDialog(ChatDialog chatDialog)
        {
